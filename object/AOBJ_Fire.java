...
public class AOBJ_Fire extends Object {
    GamePanel gp;
    private int spriteCounter = 0;
    private int spriteNum = 1;
    private final int ANIMATION_SPEED = 5; // Velocidade da animação
    ...
    public AOBJ_Fire(GamePanel gp) {
        ...
        try {
            ...
            image2 = ImageIO.read(getClass().getResourceAsStream("/res/props/fire2.png"));
            image3 = ImageIO.read(getClass().getResourceAsStream("/res/props/fire3.png"));
            image4 = ImageIO.read(getClass().getResourceAsStream("/res/props/fire4.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        collision = true;
